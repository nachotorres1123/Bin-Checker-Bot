...
async def inicio(_, m: Message):
    ...
    await m.reply_text(
        f"Hola, {mencion_usuario} 👋\n¡Estoy aquí para ayudarte a verificar tarjetas!\n\nPara más información, usa el comando /ayuda.",
...
async def generarpass(_, m: Message):
    try:
        ...
        await m.reply_text(mensaje)
    except ValueError:
        await m.reply_text("❗ Por favor, proporciona una longitud válida para la contraseña.")
