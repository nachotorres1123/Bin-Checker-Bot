...
class CardValidator:
    # ... (coloca aquí el código de la clase CardValidator que proporcionaste anteriormente)
  class CardValidator:
...
# ... (coloca aquí las funciones que proporcionaste anteriormente)

class GetGenerate:
    # ... (coloca aquí el código de la clase GetGenerate que proporcionaste anteriormente)
    class GetGenerate:
